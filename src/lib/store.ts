...
function seed() {
  ...
  const customers: Customer[] = [
    ...
    { id: "c4", name: "Fábio Afonso", phone: "(31) 98000-1111", city: "Belo Horizonte / MG" },
  ];
    ...
    c1: [
      {
        id: uid(),
        code: "FLT-OL-9821",
        description: "Filtro de óleo Tecfil PSL120",
        quantity: 6,
        sold: 0,
        unitPrice: 28.9,
      },
      {
        id: uid(),
        code: "PAS-FRE-441",
        description: "Pastilha de freio dianteira Cobreq N-441",
        quantity: 4,
        sold: 0,
        unitPrice: 89.5,
      },
      ...
      },
      {
        id: uid(),
        code: "OL-MOB-5W30",
        description: "Óleo Mobil Super 5W30 1L",
        quantity: 12,
        sold: 0,
        unitPrice: 39.9,
      },
    ...
    c2: [
      {
        id: uid(),
        code: "COR-DEN-8PK",
        description: "Correia Dentada Gates 8PK1230",
        quantity: 3,
        sold: 0,
        unitPrice: 145.0,
      },
      {
        id: uid(),
        code: "AMO-TRA-NK",
        description: "Amortecedor Traseiro Nakata",
        quantity: 2,
        sold: 0,
        unitPrice: 215.0,
      },
