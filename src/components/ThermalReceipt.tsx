...
export const ThermalReceipt = forwardRef<HTMLDivElement, { order: Order }>(function ThermalReceipt({ order }, ref) {
  ...
  return (
    <div ref={ref} className="thermal print-area">
      <div className="center">
        ...
        <div>CNPJ 17.242.529/0001-14</div>
        <div>Tel: (35)99862-5845</div>
      </div>
